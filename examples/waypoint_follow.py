import time
from vikavolt_gym.envs.base_classes import Integrator
import yaml
import gym
import numpy as np
...
def main():
    ...
    env = gym.make('vikavolt_gym:vikavolt-v0', map=conf.map_path, map_ext=conf.map_ext, num_agents=1, timestep=0.01, integrator=Integrator.RK4)
